(() => {
        ...
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                ...
                if (document.documentElement.classList.contains("catalogue-open")) {
                    ...
                    document.querySelector("._sub-menu_open") ? document.querySelector("._sub-menu_open").classList.remove("_sub-menu_open") : null;
                    document.querySelector("._sub-menu_active") ? document.querySelector("._sub-menu_active").classList.remove("_sub-menu_active") : null;
                }
            }
        }));
    }
    ...
    function initSliders() {
        if (document.querySelector(".carousel-hero__slider")) new core(".carousel-hero__slider", {
            ...
            on: {
                init: function(swiper) {
                    const totalSlides = document.querySelector(".swiper-fraction__total");
                    totalSlides.innerHTML = swiper.slides.length;
                },
                slideChange: function(swiper) {
                    const curSlide = document.querySelector(".swiper-fraction__current");
                    curSlide.innerHTML = swiper.realIndex + 1 < 10 ? `0${swiper.realIndex + 1}` : `${swiper.realIndex + 1}`;
                }
            }
        });
        if (document.querySelector(".slider-product-1")) new core(".slider-product__slider-1", {
            modules: [ Pagination, Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            on: {
                init: function(swiper) {
                    const totalSlides = document.querySelector(".slider-product__total-1");
                    totalSlides.innerHTML = swiper.slides.length;
                },
                slideChange: function(swiper) {
                    const curSlide = document.querySelector(".slider-product__current-1");
                    curSlide.innerHTML = swiper.realIndex + 1 < 10 ? `0${swiper.realIndex + 1}` : `${swiper.realIndex + 1}`;
                }
            }
        });
        if (document.querySelector(".novelty-1")) new core(".slider-novelty__slider-1", {
            modules: [ Pagination, Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            on: {
                init: function(swiper) {
                    const totalSlides = document.querySelector(".slider-novelty__total-1");
                    totalSlides.innerHTML = swiper.slides.length;
                },
                slideChange: function(swiper) {
                    const curSlide = document.querySelector(".slider-novelty__current-1");
                    curSlide.innerHTML = swiper.realIndex + 1 < 10 ? `0${swiper.realIndex + 1}` : `${swiper.realIndex + 1}`;
                }
            }
        });
        if (document.querySelector(".slider-product-2")) new core(".slider-product__slider-2", {
            modules: [ Pagination, Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            on: {
                init: function(swiper) {
                    const totalSlides = document.querySelector(".slider-product__total-2");
                    totalSlides.innerHTML = swiper.slides.length;
                },
                slideChange: function(swiper) {
                    const curSlide = document.querySelector(".slider-product__current-2");
                    curSlide.innerHTML = swiper.realIndex + 1 < 10 ? `0${swiper.realIndex + 1}` : `${swiper.realIndex + 1}`;
                }
            }
        });
        if (document.querySelector(".carousel-unit")) {
    ...
    const subBlocks = document.querySelectorAll(".submenu__box");
    if (subBlocks.length) subBlocks.forEach((subBlock => {
        const menuBlockItems = subBlock.querySelectorAll(".submenu__category").length;
        subBlock.classList.add(`submenu__box_${menuBlockItems}`);
    }));
    function documentActions(e) {
        const targetElement = e.target;
        if (targetElement.closest("[data-parent]")) {
            const subMenuId = targetElement.dataset.parent ? targetElement.dataset.parent : null;
            const subMenu = document.querySelector(`[data-submenu="${subMenuId}"]`) ? document.querySelector(`[data-submenu="${subMenuId}"]`) : null;
            if (subMenu) {
                const activeLink = document.querySelector("._sub-menu_active");
                const activeBlock = document.querySelector("._sub-menu_open");
                if (activeLink && activeLink !== targetElement) {
                    activeLink.classList.remove("_sub-menu_active");
                    activeBlock.classList.remove("_sub-menu_open");
                }
                targetElement.classList.toggle("_sub-menu_active");
                subMenu.classList.toggle("_sub-menu_open");
            }
            e.preventDefault();
        }
        if (targetElement.closest(".top-header__link_catalogue")) {
            document.documentElement.classList.add("catalogue-open");
            e.preventDefault();
        }
        if (targetElement.closest(".bottom-header__link-back")) {
            document.querySelector("._sub-menu_active") ? document.querySelector("._sub-menu_active").classList.remove("_sub-menu_active") : null;
            document.querySelector("._sub-menu_open") ? document.querySelector("._sub-menu_open").classList.remove("_sub-menu_open") : null;
            document.documentElement.classList.remove("catalogue-open");
            e.preventDefault();
